    ...
    <div class="panel-heading with-icon">
        {if $sub_view == ""}
            <div class="pull-right flip">
                <a href="{$system['system_url']}/admin/ads/add" class="btn btn-primary">
                    <i class="fa fa-plus"></i> {__("Add New Ads")}
                </a>
            </div>
        {/if}
        <i class="material-icons panel-icon">attach_money</i>
                ...
                <table class="table table-striped table-bordered table-hover js_dataTable">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <button class="btn btn-xs btn-danger js_admin-deleter" data-handle="ads" data-id="{$row['ads_id']}">
                                    <i class="fa fa-trash-o"></i>
                                </button>
                                <a href="{$system['system_url']}/admin/ads/edit/{$row['ads_id']}" class="btn btn-xs btn-primary">
    ...
    {elseif $sub_view == "add"}
        <div class="panel-body">
            <div class="alert alert-warning">
                ...
                {__("When you add mutiple ads at the samle location, they will be displayed randomly")}
            </div>
