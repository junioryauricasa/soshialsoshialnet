                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            <input  style="text-align:center; font-size: 24px;" name="reset_key" type="text" class="form-control" placeholder="_ _ _ _ _ _" required autofocus>
                        </div>
    ...
    <script id="search-for" type="text/template">
        <div class="ptb10 plr10">
            <a href="{$system['system_url']}/search/{literal}{{#hashtag}}hashtag/{{/hashtag}}{/literal}{literal}{{query}}{/literal}">
                <i class="fa fa-search pr5"></i> {__('Busqueda para')} {literal}{{#hashtag}}#{{/hashtag}}{/literal}{literal}{{query}}{/literal}
            </a>
        </div>
    </script>
    <!-- Search -->
    ...
    <div class="chat-sidebar js_chat-widget-master">
        ...
        <div class="chat-sidebar-head">
            <div class="input-group input-group-sm dropup">
                <input type="text" class="chat-sidebar-filter form-control" aria-label="{__("Search")}" placeholder="{__("Search")}">
    ...
    <script id="chat-box-new" type="text/template">
        <div class="chat-widget chat-box fresh opened">
            <div class="chat-widget-head">
                ...
                <button type="button" class="close js_chat-box-close" title="{__("Cerrar")}"><span aria-hidden="true">&times;</span></button>
                </div>
            </div>
            <div class="chat-widget-content">
                ...
                <div class="x-form chat-form x-visible">
                    <div class="chat-form-message">
                        <textarea class="js_autogrow  js_post-message" placeholder="{__("Escribe un mensaje...")}"></textarea>
                    </div>
