                ...
                <div class="post-meta">
                    ...
                    <div>
                        ...
                        {if $post['post_type'] == "shared"} 
                            {__("shared")} <a href="{$system['system_url']}/posts/{$post['origin']['post_id']}">
                    ...
                    <div class="post-time">
                        ...
                        {else}
                            <i class="fa fa-globe" data-toggle="tooltip" data-placement="top" title="{__("Compartido con")} {__("público")}"></i>
                        {/if}
                    </div>
                    <!-- post time & location & privacy -->
                </div>
        ...
        <div class="post-footer {if $post['likes'] == 0 && $post['comments'] == 0 && $post['shares'] == 0}x-hidden{/if}">
            ...
            <div class="post-stats clearfix {if $post['likes'] == 0 && $post['shares'] == 0}x-hidden{/if}">
                ...
                <span class="js_post-likes {if {$post['likes']} == 0}x-hidden{/if}">
                    <i class="fa fa-thumbs-o-up"></i> <span class="text-link" data-toggle="modal" data-url="posts/who_likes.php?post_id={$post['post_id']}"> A <span class="js_post-likes-num">{$post['likes']}</span> {__("people")}</span> - {__("like this")}
                </span>
                <!-- likes -->
            </div>
            <!-- post stats (likes & shares) -->
