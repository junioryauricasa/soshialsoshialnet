                ...
                <div class="panel-body with-nav">
                    <ul class="side-nav">
                        <li {if $view == ""}class="active selected"{/if}>
                            <a href="{$system.system_url}/settings"><i class="material-icons">settings</i> {__("Account Settings")}</a>
                        </li>
                        <li {if $view == "profile"}class="active selected"{/if}>
                            <a href="{$system.system_url}/settings/profile"><i class="material-icons">border_color</i> {__("Edit Profile")}</a>
                        </li>
                        <li {if $view == "privacy"}class="active selected"{/if}>
                            <a href="{$system.system_url}/settings/privacy"><i class="material-icons">security</i> {__("Privacy Settings")}</a>
                        </li>
                        {if $system['social_login_enabled']}
                            {if $system['facebook_login_enabled'] || $system['twitter_login_enabled'] || $system['google_login_enabled']}
                                <li {if $view == "linked"}class="active selected"{/if}>
                                    <a href="{$system.system_url}/settings/linked"><i class="material-icons">share</i> {__("Linked Accounts")}</a>
                                </li>
                            {/if}
                        {/if}
                        <li {if $view == "blocking"}class="active selected"{/if}>
                            <a href="{$system.system_url}/settings/blocking"><i class="material-icons">block</i> {__("Blocking")}</a>
                        </li>
                        <li {if $view == "delete"}class="active selected"{/if}>
                            <a href="{$system.system_url}/settings/delete"><i class="material-icons">delete</i> {__("Delete Account")}</a>
                        </li>
                    </ul>
                </div>
            </div>
            ...
            <div class="panel panel-default">
                ...
                {elseif $view == "profile"}
                    <div class="panel-heading with-icon with-nav">
                        <!-- panel title -->
                        <div class="mb20">
                            <i class="material-icons panel-icon">border_color</i>
                ...
                {elseif $view == "privacy"}
                    <div class="panel-heading with-icon">
                        <!-- panel title -->
                        <i class="material-icons panel-icon">security</i>
                ...
                {elseif $view == "linked"}
                    <div class="panel-heading with-icon">
                        <!-- panel title -->
                        <i class="material-icons panel-icon">share</i>
                ...
                {elseif $view == "blocking"}
                    <div class="panel-heading with-icon">
                        <!-- panel title -->
                        <i class="material-icons panel-icon">block</i>
                ...
                {elseif $view == "delete"}
                    <div class="panel-heading with-icon">
                        <!-- panel title -->
                        <i class="material-icons panel-icon">delete</i>
